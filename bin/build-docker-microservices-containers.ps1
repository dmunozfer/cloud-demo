# -------------------------------------------------------------------------------------
# -- Script regenera y ejecuta todos los contenedores de los microservicios de la demo.
# -- Las operaciones que realiza son:
# --   + Elimina todos los contenedores de las aplicaciones
# --   + Elimina todas las imágenes de las aplicaciones
# --   + Regenera las aplicaciones de las imágenes
